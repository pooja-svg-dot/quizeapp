...
public class Project5 {
	    ...
	    public static void main(String[] args) {
	        ...
	        System.out.println("1. There will be 10 questions, each with 6 options.");
	        System.out.println("2. You must choose the correct answer (1-6) for each question.");
	        ...
	        System.out.println("5. you have 2 lifelines which can be used only once.");
	        String[] questions = {
	        ...
	        String[][] options = {
	            ...
	            {"1.print()","2.console.log()","3.System.out.print()","4.echo()","5.lifeline","6.quit"},
	            {"1.main()","2.start()","3.run()","4.begin()","5.lifeline","6.quit"},
	            {"1.stack()","2.heap()","3.data segment","4.register","5.lifeline","6.quit"},
	        ...
	        for (int i = 0; i < questions.length; i++) {
	            ...
	            System.out.println("type 'quit' to exit the game or press enter to continue");
